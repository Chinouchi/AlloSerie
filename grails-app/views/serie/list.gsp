                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="imagePath" title="${message(code: 'serie.imagePath.label', default: 'Image Path')}" />
                    ...
                    <g:each in="${serieInstanceList}" status="i" var="serieInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" id="${serieInstance.id}">${fieldValue(bean: serieInstance, field: "id")}</g:link></td>
