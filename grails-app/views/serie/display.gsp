            ...
            <tr>
                ...
                <td>
                    ...
                    <g:if test="${serieInstance.rating == 0}">
                        <span><strong>Rating :</strong> <img src="${resource(dir: "images", "/zero_star.png")}" alt="">
                        </span>  <br/>
                    </g:if>
                    <g:elseif test="${serieInstance.rating == 1}">
                        <span><strong>Rating :</strong> <img src="${resource(dir: "images", "/one_star.png")}" alt="">
                        </span>  <br/>
                    </g:elseif>
                    <g:elseif test="${serieInstance.rating == 2}">
                        <span><strong>Rating :</strong> <img src="${resource(dir: "images", "/two_star.png")}" alt="">
                        </span>  <br/>
                    </g:elseif>
                    <g:elseif test="${serieInstance.rating == 3}">
                        <span><strong>Rating :</strong> <img src="${resource(dir: "images", "/three_star.png")}" alt="">
                        </span>  <br/>
                    </g:elseif>
                    <g:elseif test="${serieInstance.rating == 4}">
                        <span><strong>Rating :</strong> <img src="${resource(dir: "images", "/four_star.png")}" alt="">
                        </span>  <br/>
                    </g:elseif>
                    <g:elseif test="${serieInstance.rating == 5}">
                        <span><strong>Rating :</strong> <img src="${resource(dir: "images", "/five_star.png")}" alt="">
                        </span>  <br/>
                    </g:elseif>
                    <span><strong>Desciption :</strong></span> <br/>

                    <p>${serieInstance?.description}</p>  <br/>
                    <span><strong>number of comments :</strong>${serieInstance.commentaires.size()}</span>   <br/>
                </td>
            </tr>
            </tbody>
        </table>
            ...
            <table class="acteurs">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span>Date de naissance : <g:formatDate format="dd-MM-yyyy"
                                                                date="${currentActor.birthDate}"/></span><br/>
                            ...
                            <table>
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="auteur"><g:message code="commentaire.auteur.label"
                                                                       default="Auteur"/></label>
                                    </td>
                                    <td valign="top"
                                        class="value ${hasErrors(bean: commentaireInstance, field: 'auteur', 'errors')}">
                                ...
                                <tr class="prop">
                                    <td valign="top" class="name">
                                        <label for="comment"><g:message code="commentaire.comment.label"
                                                                        default="Comment"/></label>
                                    </td>
                                    <td valign="top"
                                        class="value ${hasErrors(bean: commentaireInstance, field: 'comment', 'errors')}">
                ...
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: serieInstance, field: 'actors', 'errors')}">
                            <g:select name="actors" from="${alloserie.Actor.list()}" multiple="yes" optionKey="id"
                                      optionValue="fullName" size="5" value="${serieInstance?.actors*.id}"/>
                        </td>
                    </tr>
