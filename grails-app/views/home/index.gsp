        ...
        <div class="toptvscroll">
            ...
            <div class="items">
                ...
                <g:each in="${Serie.findAll().sort {a,b-> b.rating.compareTo(a.rating)}}" var="bestSerie">
                    ...
                    <g:link controller="serie" action="display" id="${bestSerie.id}"><img
                            src="${resource(dir: "images", file: bestSerie.imagePath)}" alt=""></g:link>
                </g:each>
                <g:if test="${i!=5}">
                    </div>
                </g:if>
                ...
                <div class="dialog">
                    <table>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                class="value ${hasErrors(bean: serieInstance, field: 'name', 'errors')}">
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                class="value ${hasErrors(bean: serieInstance, field: 'rating', 'errors')}">
                                <g:textField name="rating"
                                             value="${fieldValue(bean: serieInstance, field: 'rating')}"/>
                            </td>
                        </tr>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                class="value ${hasErrors(bean: serieInstance, field: 'genre', 'errors')}">
                ...
                <div class="dialog">
                    <table>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top"
                                class="value ${hasErrors(bean: actorInstance, field: 'bio', 'errors')}">
